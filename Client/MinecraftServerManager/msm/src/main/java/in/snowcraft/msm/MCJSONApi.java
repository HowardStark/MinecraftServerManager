...
public class MCJSONApi {
    ...
    public MCJSONApi(String username, String password, String address, int port, boolean first){
        ...
        this.port = port;
        if(first == true){
            call("server.version", new String[0]);
            first = false;
        }
    }
    ...
    public String call(String method, String args[]){
        ...
        System.out.println("Test 4: Better Hashing. Username: " + username + ". Password: " + password + ". Method: " + method + ". Key: " + key + ".");
